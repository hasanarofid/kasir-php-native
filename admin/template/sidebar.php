...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">Simple Kas<sup></sup></div>
    </a>
    ...
    <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="index.php?page=masuk">Barang Masuk</a>
                <a class="collapse-item" href="index.php?page=keluar">Barang Keluar</a>
    ...
    <li class="nav-item active">
        <a class="nav-link" href="index.php?page=laporans">
            <i class="fas fa-fw fa-book"></i>
